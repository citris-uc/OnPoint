  ...
  DragDrop.prototype = {
    listen: function() {
      ...
      function ontouchend(event) {
        log("====ONTOUCHEND==== event: " + event.type);
    ...
    dragend: function(event) {
      ...
      log("== dragend ==");
      //console.log("event: dropEffect: " + event.dataTransfer.dropEffect);
      if (this.lastEnter) {
        this.dispatchLeave(event);
      }
      ...
      if (target) {
        ...
        dragendEvt.initEvent("dragend2", true, true);
    ...
    dispatchDrop: function(target, event) {
      log("DispatchDrop: ", event.type);
      var dropEvt = doc.createEvent("Event");
      dropEvt.initEvent("drop2", true, true);
      ...
      log("Dispatch Drop: dropEffect: " + dropEvt.dataTransfer.dropEffect);
    ...
    dispatchDragStart: function() {
      log("====Dispatch Drag Start====");
      var evt = doc.createEvent("Event");
      evt.initEvent("dragstart2", true, true);
      log("initialize dragstart");
      evt.dataTransfer = {
